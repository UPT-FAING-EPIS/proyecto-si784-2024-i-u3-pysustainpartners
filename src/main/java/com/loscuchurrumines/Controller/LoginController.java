...
public class LoginController extends HttpServlet {
    ...
    private static final String SECRET_KEY = dotenv.get(
        "RECAPTCHA_PRIVATE_KEY"
    );

    private static final String DEFAULT_REQUEST_VIEWER =
    ...
    protected void doGet(
        ...
        try {
            ...
            request
                .getRequestDispatcher(DEFAULT_REQUEST_VIEWER)
    ...
    protected void doPost(
        ...
        try {
            ...
            if (isCaptchaValid) {
                ...
                request.setAttribute(
                    ERROR,
                    "Captcha inválido. Por favor, inténtelo de nuevo."
                );
                request
                    .getRequestDispatcher(DEFAULT_REQUEST_VIEWER)
                    .forward(request, response);
    ...
    public static boolean verify(String gRecaptchaResponse, String secretKey) {
        ...
        try {
            ...
            String params =
                "secret=" +
                URLEncoder.encode(secretKey, UTF_8) +
                "&response=" +
                URLEncoder.encode(gRecaptchaResponse, UTF_8);
